...
const imgs = [
  ...
  '//images.unsplash.com/photo-1570215171323-4ec328f3f5fa?crop&w=1300&q=100',
  '//images.unsplash.com/photo-1513343041531-f73bffeed81b?crop&w=1300&q=100',
];

function UnauthenticatedContainer({ children }) {
      ...
      <Column.Group marginless className="is-fullpage">
        ...
        >
          <div className="has-text-centered login-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 39">
              <g fill="currentColor">
