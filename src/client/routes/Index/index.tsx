      ...
      <Box as="section" mt={2}>
        ...
        <Stack spacing={1} m={4}>
          <Feature state={FeatureState.DONE}>
            built with <ExternalLink href="//nextjs.org/">Next.js</ExternalLink>
            , powered by{' '}
            <ExternalLink href="//reactjs.org/">React</ExternalLink>
          </Feature>
          ...
          <Feature state={FeatureState.DONE}>
            UI via{' '}
            <ExternalLink href="//chakra-ui.com/">@chakra-ui/core</ExternalLink>{' '}
          </Feature>
